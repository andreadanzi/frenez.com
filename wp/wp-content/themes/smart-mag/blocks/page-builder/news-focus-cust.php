...
class Bunyad_PageBuilder_NewsFocusCust extends Bunyad_PageBuilder_WidgetBase
{
	...
	{
		parent::__construct(
			'bunyad_pagebuilder_news_focus_cust',
			__('News Focus Custom Block', 'bunyad'),
			array('description' => __('A custom block that lists news from a parent categories, making the latest one prominent, and have tabs for sub-categories.', 'bunyad'))
		);
	}
	...
	public function widget($args, $instance)
	{
		...
		echo '[news_focus_cust '. implode(' ', $this->shortcode_attribs($instance, $attrs)) .' /]';
