...
/** danzi.tn@20140401 spostare slider in basso
...
<!-- danzi.tn@20140401 page-blocks.php -->
<div class="main wrap cf">

	<div class="row">
		<div class="col-8 main-content">
			<?php /** danzi.tn@20140401 spostare slider in basso */
				if (Bunyad::posts()->meta('featured_slider')):
					get_template_part('partial-custom-sliders');
				endif; 
			?>
