...
class wpdf_API_request {
	...
	function api_content_request($keyword,$num,$start,$source,$optionsarray,$feed="") {
		...
		// danzi.tn@20140402 aggiunto user_id, vedi info_sources_options per template
		$user_id = $optionsarray["user_id"]["value"]; // "122036906@N06";
		$requrl = str_replace("{user_id}", $user_id, $requrl);	
		// danzi.tn@20140402e
