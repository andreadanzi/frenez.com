                ...
                {foreach key=maintabs item=detail from=$MENUSTRUCTURE}
                    ...
                    {foreach key=number item = name from = $detail}
                        ...
                        {if $modulelabel ne $MODULE_NAME}
							{if $modulelabel eq 'Calendar'}
								<td class="tabUnSelected"  align="center" nowrap><a href="index.php?module={$name[0]}&action=ListView">{$modulename}</a></td>
						...
						{else}
							{if $modulelabel eq 'Calendar'}
								<td class="tabSelected"  align="center" nowrap><a href="index.php?module={$name[0]}&action=ListView">{$modulename}</a></td>
								<td class="tabSeperator"><img src="{'spacer.gif'|@vtiger_imageurl:$THEME}"></td>
							{else}
